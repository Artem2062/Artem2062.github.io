...
game.open('GET', 'https://studyprograms.informatics.ru/api/jsonstorage/?id=ba139e09feaaf1e81a72e8e68db8a569', true);
game.send();
if (document.title == "Game") {
    ...
    loseButton.addEventListener('click', function () {
        ...
        game2.open('GET', 'https://studyprograms.informatics.ru/api/jsonstorage/?id=ba139e09feaaf1e81a72e8e68db8a569', true);
        game2.send();
                ...
                if (game2.status == 200) {
                    ...
                    for (let i = 0; i < gameArr4.length; i++) {
                        if (gameArr4[i][10] == localStorage.getItem('login')) {
                            ...
                            gameSender4.open('PUT', 'https://studyprograms.informatics.ru/api/jsonstorage/?id=ba139e09feaaf1e81a72e8e68db8a569', true);
    ...
    document.addEventListener('click', function (e) {
        ...
        if (localStorage.getItem('gameStarted') == 1) {
            ...
            gamestep.open('GET', 'https://studyprograms.informatics.ru/api/jsonstorage/?id=ba139e09feaaf1e81a72e8e68db8a569', true);
            gamestep.send();
            gamestep.addEventListener('readystatechange', function () {
                if (gamestep.readyState == 4 && gamestep.status == 200) {
                    ...
                    for (let elem of gameArr) {
                        if (elem[10].login == localStorage.getItem('mylogin')) {
                                                        ...
                                                        for (let field of fieldsArr2) {
                                                            if (field.creator + field.count == localStorage.getItem('fieldName')) {
                                                                if (field.players == 2) {
                                                                    ...
                                                                    fieldcheck2.open('GET', 'https://studyprograms.informatics.ru/api/jsonstorage/?id=ba139e09feaaf1e81a72e8e68db8a569', true);
                                                                    fieldcheck2.send();
                                                                    fieldcheck2.addEventListener('readystatechange', function () {
                                                                        if (fieldcheck2.readyState == 4 && fieldcheck2.status == 200) {
                                                                            ...
                                                                            gameSender2.open('PUT', 'https://studyprograms.informatics.ru/api/jsonstorage/?id=ba139e09feaaf1e81a72e8e68db8a569', true);
                                        ...
                                        if (field.players == 1 && flagplayers == true) {
                                            ...
                                            fieldcheck2.addEventListener('readystatechange', function () {
                                                if (fieldcheck2.readyState == 4 && fieldcheck2.status == 200) {
                                                    ...
                                                    gameSender.open('PUT', 'https://studyprograms.informatics.ru/api/jsonstorage/?id=ba139e09feaaf1e81a72e8e68db8a569', true);
